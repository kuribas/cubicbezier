module CubicBezier.Bezier where
import Data.List
...
-- | find where the bezier curve is horizontal
bezierHoriz = bezierFindTangent (Point 1 0)

-- | find where the bezier curve is vertical
bezierVert = bezierFindTangent (Point 0 1)
...
-- | find cusps on the curve
findBezierCusps :: CubicBezier -> [Double]
